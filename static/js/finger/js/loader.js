...
define(["toServer","CubeTest","CameraTest","LineTest","TextureTest","SimpleLightTest","MoreLightTest","TwoTexturesMoreLightTest",
        "TransparentTest","LightingTest","ClippingTest","BubbleTest","CompressedTextureTest","ShadowTest","util","process","meshes"],
      function(Sender,CubeTest,CameraTest,LineTest,TextureTest,SimpleLightTest,MoreLightTest,TwoTexturesMoreLightTest,
        TransparentTest, LightingTest,ClippingTest,BubbleTest,CompressedTextureTest,ShadowTest,
        util,process,meshes ) {
  // (function() {
    ...
    Loader = (function() {
      ...
      Loader.prototype.beginTests = function() {
        ...
        $("<canvas id='can_aa'  style='opacity:1;' width='" + d + "' height='" + d + "'/>").appendTo(canvasContainer);
